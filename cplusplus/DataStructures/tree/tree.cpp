...
explicit ShowMeTheDataStructure::Tree::Tree(char h, Tree *l = nullptr, Tree *r = nullptr)
{
    expr = std::string(1, h);
    left = l;
    right = r;
...
explicit ShowMeTheDataStructure::Tree::Tree(const std::string &h = std::string(), Tree *l = nullptr, Tree *r = nullptr)
{
    expr = h;
    left = l;
    right = r;
